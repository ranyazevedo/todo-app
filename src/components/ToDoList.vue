<template>
  <ul class="max-w-lg w-full m-auto my-5">
    <li
      v-for="task in data"
      :key="task"
      ...
      <div class="min-w-xs">
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-6 h-6 stroke-1 stroke-sky-700 hover:stroke-sky-500"
          >
            <path
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-6 h-6 stroke-1 stroke-rose-600 hover:stroke-rose-400"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
  ...
  <div class="m-5" v-if="!data.length">No tasks founds</div>
</template>
